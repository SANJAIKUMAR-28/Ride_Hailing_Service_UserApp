  ...
  Future<void> verifyPhoneNumber() async {
    ...
    final PhoneCodeSent smsSent = (String verificationId, int? forceResendingToken) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => MobileOtp( verificationId: _verificationId, num: '+91 ${passwordEditingController.text}', name: emailEditingController.text, page: '2',),
        ),
      );
    };
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Sign Up',style: TextStyle(fontFamily: 'Arimo',fontWeight: FontWeight.bold,fontSize: 25),),
                    SizedBox(height: 5,),
                    Text('Create your account with name and\nphone number',style: TextStyle(fontFamily: 'Arimo',fontSize: 15),),
                    SizedBox(height: 30,),
                    emailField,
                    SizedBox(
                      height: 15,
