...
db.Query dbRef = db.FirebaseDatabase.instance.ref().child('IntercityRequests');
db.DatabaseReference reference = db.FirebaseDatabase.instance.ref().child('IntercityRequests');
@override
void initState() {
  super.initState();
      ...
      child: Column(
        ...
        children: [
          if(request['PASSENGER-ID']=='${loggedInUser.uid}')
            historyBox(request['FROM'], request['TO'], request['DEPARTURE-TIME'], request['DEPARTURE-TIME'], request['DEPARTURE-DATE'], request['STATUS'])
        ],
      ),
    ),
  );
